...
import EditMarketplaceAbout from '../uiComponents/pages/EditMarketplaceAbout'
import EditMarketplaceHomepage from '../uiComponents/pages/EditMarketplaceHomepage'
    ...
    return (
        <Routes>
            <Route path="/" element={<Home claimReward={claimReward} setClaimedReward={setClaimedReward} />}>
                ...
                <Route path="/marketplace/edit-home-page" element={<EditMarketplaceHomepage />} />
                <Route path="/marketplace/edit-about-page" element={<EditMarketplaceAbout />} />
                
                <Route path="/marketplace/update-header" >
